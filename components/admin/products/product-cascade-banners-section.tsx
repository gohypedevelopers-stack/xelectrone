...
export function ProductCascadeBannersSection({
  ...
  async function handleFileUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      alert(err.message || "Failed to upload cascade image(s).");
    } finally {
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-black/10 pb-3">
        <div>
          ...
          <p className="text-xs text-black/50">
            Upload sliding banners to display an interactive swipeable carousel on the product page.
          </p>
        </div>
        ...
        >
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-[11px] text-black/50">
              Select 1 or more landscape slides to create an interactive sliding carousel.
            </p>
          </div>
        </div>
      ) : (
        <div className="space-y-2.5">
          {banners.map((banner, index) => (
            <div
              ...
              className="flex flex-col sm:flex-row items-center gap-3 rounded-xl border border-black/10 bg-slate-50/50 p-2.5 hover:bg-slate-50 transition shadow-2xs"
            >
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <div
                  ...
                  className="relative h-12 w-20 shrink-0 overflow-hidden rounded-lg border border-black/15 bg-slate-100 flex items-center justify-center cursor-pointer group shadow-2xs"
                  title="Desktop Banner (Click to change)"
                >
                  {banner.imageUrl ? (
                ...
                <div
                  ...
                  title={banner.mobileImageUrl ? "Phone Banner (Click to change)" : "Click to upload phone banner"}
                >
                  {banner.mobileImageUrl ? (
